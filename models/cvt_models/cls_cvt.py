...
class ConvolutionalVisionTransformer(nn.Module):
    ...
    def init_weights(self, pretrained='', pretrained_layers=[], verbose=True):
        pretrained = '{}/.cache/torch/hub/checkpoints/CvT-w24-384x384-IN-22k.pth'.format(os.environ['HOME'])
...
def cvt_21_384(pretrained=False, **kwargs):
    args = Namespace(cfg='models/cvt_models/cvt-w24-384x384.yaml', opts=[])
    update_config(config, args)
    model = get_cls_model(config, **kwargs)
    return model